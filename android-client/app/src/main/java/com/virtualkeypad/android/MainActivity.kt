...
class MainActivity : AppCompatActivity(), RelayConnectionManager.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        labelInputs = mapOf(
            ...
            "top1" to findViewById(R.id.labelTop1Input),
            "top2" to findViewById(R.id.labelTop2Input),
            "top3" to findViewById(R.id.labelTop3Input),
            "top4" to findViewById(R.id.labelTop4Input),
            "top5" to findViewById(R.id.labelTop5Input),
        ...
        keyInputs = mapOf(
            ...
            "top1" to findViewById(R.id.keyTop1Input),
            "top2" to findViewById(R.id.keyTop2Input),
            "top3" to findViewById(R.id.keyTop3Input),
            "top4" to findViewById(R.id.keyTop4Input),
            "top5" to findViewById(R.id.keyTop5Input),
        ...
        delayInputs = mapOf(
            ...
            "top1" to findViewById(R.id.delayTop1Input),
            "top2" to findViewById(R.id.delayTop2Input),
            "top3" to findViewById(R.id.delayTop3Input),
            "top4" to findViewById(R.id.delayTop4Input),
            "top5" to findViewById(R.id.delayTop5Input),
